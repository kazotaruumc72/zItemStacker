 ...
 * Uses the Folia-aware {@link Scheduler} to handle the timing and updates of the BossBar.
 */
public class BarAnimation {
    ...
    public BarAnimation(List<Player> players, String text, int seconds, BarColor barColor, BarStyle barStyle) {
        ...
        this.task = Scheduler.runGlobalTimer(JavaPlugin.getProvidingPlugin(getClass()), this::tick, 1L, 1L);
    }
